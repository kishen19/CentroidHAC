...
bazel run //Centroid/HeapBased:centroid_main -- -R 32 -L 64 -alpha 1.2 -two_pass 1 -data_type float -dist_func Euclidean -base_path /ssd2/kishen/anndata/sift/sift_learn.fbin -graph_path /ssd2/kishen/anndata/sift/sift_learn_32_64
